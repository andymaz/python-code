...
class Latin(object):
    ...
    def solved(self):
        temp = self.board[0] + self.board[1] + self.board[2]
        return self.board[3] + self.board[4] + self.board[5] == temp and \
            self.board[6] + self.board[7] + self.board[8] == temp and \
            self.board[0] + self.board[3] + self.board[6] == temp and \
            self.board[1] + self.board[4] + self.board[7] == temp and \
            self.board[2] + self.board[5] + self.board[8] == temp and \
            self.board[0] + self.board[4] + self.board[8] == temp and \
            self.board[2] + self.board[4] + self.board[6] == temp
